...
export default function EditPelaku({saksi} : Props) {
    const defaultValues = {
        name: saksi.name || '',
        tempat_lahir: saksi.tempat_lahir || '',
        tanggal_lahir: saksi.tanggal_lahir || '',
        agama: saksi.agama || '',
        pekerjaan: saksi.pekerjaan || '',
        jenis_kelamin: (saksi.jenis_kelamin === 'L' || saksi.jenis_kelamin === 'P')
            ? saksi.jenis_kelamin
            : 'L' as const,
        alamat: saksi.alamat || '',
        status: (saksi.status === 'lajang' || saksi.status === 'menikah')
            ? saksi.status
            : 'lajang' as const,
    };
    ...
    const onSubmit = (data: z.infer<typeof formSchema>) => {
        router.put(`/saksi/${saksi.id}`, data);
    };
